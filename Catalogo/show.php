...
$videojuego = mysql_query("SELECT v.*, vc.* FROM videojuegos v JOIN videojuego_caracteristicas vc ON v.id_videojuego = vc.id_videojuego WHERE v.Nombre='" . $_GET['nombre'] . "'",$conexion);
$atributos = mysql_query("SELECT * FROM videojuegos v JOIN videojuego_atributos va ON  v.id_videojuego = va.id_videojuego WHERE v.Nombre = '" . $_GET['nombre'] . "'");
$pros = mysql_query("SELECT * FROM videojuegos v JOIN videojuego_pros_contras vpc  ON v.id_videojuego = vpc.id_videojuego WHERE v.Nombre = '" . $_GET['nombre'] . "' AND vpc.Tipo_pro_contra = 'pro'");
$contras = mysql_query("SELECT * FROM videojuegos v JOIN videojuego_pros_contras vpc  ON v.id_videojuego = vpc.id_videojuego WHERE v.Nombre = '" . $_GET['nombre'] . "' AND vpc.Tipo_pro_contra = 'contra'");
